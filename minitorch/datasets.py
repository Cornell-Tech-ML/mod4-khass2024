...
def make_pts(N: int) -> List[Tuple[float, float]]:
    ...
    Returns:
    -------
        List[Tuple[float, float]]: A list of N tuples, each containing two random floats between 0 and 1.
...
class Graph:
    ...
    ----------
        ...
        y (List[int]): List of classifications for each point (0 or 1).
...
def diag(N: int) -> Graph:
    """Generate a diagonal classification problem.
...
def split(N: int) -> Graph:
    """Generate a split classification problem.
...
def xor(N: int) -> Graph:
    """Generate an XOR classification problem.
...
def circle(N: int) -> Graph:
    """Generate a circular classification problem.
...
def spiral(N: int) -> Graph:
    """Generate a spiral classification problem.
